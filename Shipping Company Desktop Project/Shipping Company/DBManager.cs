...
namespace Shipping_Company
{
    ...
    {
        static string DB_Connection_String = @"Data Source=shippingcompany.database.windows.net;Initial Catalog=shippingcompany;User ID=AboSnow1;Password=AboGaber123$";
